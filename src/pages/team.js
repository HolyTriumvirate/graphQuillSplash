...
const SecondPage = () => (
  <Layout>
    ...
    <h2>Austin</h2>
    <p>A user experience genius and manager par excelence, Austin is capable of communicating with users, programmers, and codebases young and old. His connections to the wider developer community brought about the idea of GraphQuill, and it is fondest hope that he and his team continue to deliver useful, relevant work.</p>
    <h2>Ed</h2>
